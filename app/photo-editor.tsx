  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <View style={styles.topBar}>
        <Pressable onPress={() => router.back()} style={styles.iconBtn} hitSlop={10} accessibilityRole="button" accessibilityLabel="Fermer l'éditeur">
          <MaterialIcons name="close" size={24} color={Colors.textPrimary} />
        </Pressable>
        <Text style={styles.topTitle} numberOfLines={1}>{photoName}</Text>
        <View style={styles.topRight}>
          {hasEdits ? (
            <Pressable onPress={handleUndo} style={styles.iconBtn} hitSlop={10} accessibilityRole="button" accessibilityLabel="Annuler la dernière modification">
              <MaterialIcons name="undo" size={22} color={Colors.textSecondary} />
            </Pressable>
          ) : null}
          {hasEdits ? (
            <Pressable onPress={handleClearAll} style={styles.iconBtn} hitSlop={10} accessibilityRole="button" accessibilityLabel="Effacer toutes les modifications">
