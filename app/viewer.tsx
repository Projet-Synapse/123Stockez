  ...
  const handleShare = async () => {
    try {
      await Share.share(
        ...
        { subject: `Photo : ${displayName}`, dialogTitle: `Partager « ${displayName} »` },
      );
    } catch {
      ...
      {uiVisible ? (
        <View style={[styles.topBar, { paddingTop: insets.top + Spacing.sm }]}>
          ...
          <Pressable
            ...
            hitSlop={8}
            accessibilityRole="button"
            accessibilityLabel="Renommer la photo"
          >
          ...
          <Pressable
            ...
            hitSlop={12}
            accessibilityRole="button"
            accessibilityLabel="Partager la photo"
          >
          ...
          <Pressable
            onPress={() =>
              router.push({
                ...
                params: { photoUri, photoName: displayName, photoId, albumId: currentPhoto?.albumId ?? '' },
              })
            }
